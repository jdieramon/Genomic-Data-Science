...
# Now I have these coefficients that have been adjusted for batch effects. 
# So, I can now look at the coefficients for the variable that I care about across
# all of the different samples. 
hist(fit$coefficients[2,],col=2,breaks=100)

## ------------------------------------------------------------------------
table(pheno$cancer,pheno$batch)
# If all the cancer samples were on batch1 and the normal samples on batch2,
# we cannot use any of the adjustment methods we are going to see. 
